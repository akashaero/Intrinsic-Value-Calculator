...
No model or technique is perfect and nothing is going to give you an exact price at which a business should be bought. What this model helps with is getting you closer to the true value of a business while taking your assumptions about the business at face value.
...
This company would have to grow at a 52.05% average annual rate for the next 7 years
...
4. --N <number_of_years_in_future> (Optional): Number of years for which you want to forecast revenue growth and free cash flow margins (Default 7)
5. --rrr <required_rate>           (Optional): Required rate of return (Default 10%)
6. --tgr <terminal_growth_rate>    (Optional): Terminal growth rate of a company (Default 2.5%)
