...
## Graphical User Interface ([Download for Windows](https://github.com/akashaero/Intrinsic-Value-Calculator/releases/download/v0.3.1/Intrinsic-Value-Calculator-Windows.zip)) ([Download for Linux](https://github.com/akashaero/Intrinsic-Value-Calculator/releases/download/v0.3.1/Intrinsic-Value-Calculator-Linux.zip))
